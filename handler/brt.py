...
def brt(tracking_number):
    ...
    try:
        ...
        if response.status_code == 200:
            print_task("[brt %s] successful got session..." %
            ...
            BIGipServerAS777_Pool = response.cookies.get_dict()[
            ...
            response = session.post('https://vas.brt.it/vas/sped_det_show.htm', cookies=cookies,
            ...
            if it in response.text or en in response.text or fr in response.text:
                ...
                print_task("[brt %s] successful got data..." %
                ...
                print_task("[brt %s] error: %s" %
                           (tracking_number, "invalid tracking number..."), RED)
                return
